...
def main():
    ...
    if 'tab_selecionada' not in st.session_state:
        st.session_state.tab_selecionada = "📋 REGRAS"

    tab_opcoes = ["📋 REGRAS", "📊 ANÁLISE & SCORES", "🎲 JOGOS"]

    # Radio horizontal para navegação
    tab_selecionada = st.radio(
        "Navegação",
        tab_opcoes,
        index=tab_opcoes.index(st.session_state.tab_selecionada),
        horizontal=True,
    ...
    if tab_selecionada != st.session_state.tab_selecionada:
        st.session_state.tab_selecionada = tab_selecionada

    st.markdown("---")

    # ==========================================================================
    # TAB 1: QUADRO DE REGRAS
    # ==========================================================================
    if st.session_state.tab_selecionada == "📋 REGRAS":
    ...
    # ==========================================================================
    # TAB 2: ANÁLISE & SCORES
    # ==========================================================================
    elif st.session_state.tab_selecionada == "📊 ANÁLISE & SCORES":
